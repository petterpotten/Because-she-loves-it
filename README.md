...
> **📱 Nota importante:** Esta rama (`main`) está optimizada para **pantallas web/escritorio**. Si necesitas la versión responsive para móviles, cambia a la rama [`mainResponsive`](../../tree/mainResponsive).
...
- 💻 Optimizada para pantallas web/escritorio (versión responsive en rama `mainResponsive`)
